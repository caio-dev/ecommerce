...
$app->post("/profile", function(){
    ...
    if ($_POST['desemail'] !== $user->getdesemail()) {
        ...
        if (User::checkLoginExist($_POST['desemail']) === true){
            ...
            User::setError("Este E-mail já está sendo utilizado!");
            header("Location: /profile");
            exit;
        }
    }
...
$app->get("/boleto/:idorder", function($idorder){
    ...
    // SEUS DADOS
    $dadosboleto["identificacao"] = "Caio Store";
    $dadosboleto["cpf_cnpj"] = "68.740.137/0001-16";
    $dadosboleto["endereco"] = "Rua da Moeda - Recife, 50030-230";
    $dadosboleto["cidade_uf"] = "Recife - PE";
    $dadosboleto["cedente"] = "CAIO STORE LTDA";
